...
public class Userform extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 51)), "USER FORM", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Consolas", 0, 18), new java.awt.Color(51, 51, 51))); // NOI18N
        jPanel3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel3.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 250, 34));
        jPanel3.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 170, 250, 34));
        jPanel3.add(pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 220, 250, 34));

        jLabel1.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        jLabel1.setText("User Gender");
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 290, -1, -1));
        ...
        jPanel3.add(gen, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 280, 250, 40));
        ...
        jPanel3.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 390, -1, -1));
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
       ...
       String sql ="DELETE FROM USERPOST WHERE USER_ID=?";
        try {
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
       ...
       String sql ="INSERT INTO USERPOST VALUES(?,?,?,?)";
        try {
            ...
            ps.setString(1, id.getText());
            ps.setString(2, (String) gen.getSelectedItem());
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
           String db = "jdbc:derby://localhost:1527/zenbase";
       String sql ="UPDATE USERPOST SET USER_GENDER=?, USER_NAME=?, USER_PASSWORD=? WHERE USER_ID=?";
        try {
            Connection con = DriverManager.getConnection(db);
            PreparedStatement ps = con.prepareStatement(sql);
            
           
            ps.setString(1, (String) gen.getSelectedItem());
