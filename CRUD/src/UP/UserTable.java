...
public class UserTable extends javax.swing.JFrame {
    ...
    public UserTable() {
     ...
     private void fetch(){
         String URL = "jdbc:derby://localhost:1527/zenbase";
       
        try (Connection con = DriverManager.getConnection(URL);
                Statement st =con.createStatement();
                ResultSet rs = st.executeQuery("Select * From USERPOST")){
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 610, 390));
